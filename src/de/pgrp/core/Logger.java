...
public class Logger {
	...
	public Logger() {
		try {
			...
			String date = getYear() + getMonth() + getDayOfMonth() + "_"
	 ...
	 * 
	 * @param filename
	 *            is the name of the logfile as string
	 */
	...
	/**
	 * Returns a string representing the current date and time in the following
	 * syle: "[YYYY/MM/DD HH:MM::SS] - "
	 * 
	 * @return tmp the string
	 */
	private String getTimeString() {
		this.cal = Calendar.getInstance();
		String tmp = "[" + getYear() + "/" + getMonth() + "/" + getDayOfMonth()
	...
	/**
	 * Adds a message to the current log, this message displays on the console
	 * and is written into the logfile
	 * 
	 * @param txt
	 *            the logged string
	 */
	...
	/**
	 * Adds a message to the current log, this message displays on the console
	 * (colored) and is written into the logfile
	 * 
	 * @param txt
	 *            the logged string
	 * @param color
		...
		try {
			...
			if (this.color) {
				...
				case 1: /* Red */
					...
					System.out
					.print(time + "\033[31m" + txt + "\033[0m" + '\n');
					break;
				case 2: /* Green */
					this.bw.write(time + txt + '\n');
					System.out
					.print(time + "\033[32m" + txt + "\033[0m" + '\n');
					break;
				case 3: /* Blue */
					this.bw.write(time + txt + '\n');
					System.out
					.print(time + "\033[34m" + txt + "\033[0m" + '\n');
					break;
				case 4: /* Yellow */
					this.bw.write(time + txt + '\n');
